  ...
  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-md ring-1 ring-slate-200 transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl hover:bg-red-500">
      ...
      <div className="relative z-10 flex h-full flex-col p-6">
        ...
        <Link
          href={vertical.href}
          className="mt-2 inline-block w-fit rounded text-sm font-semibold text-[#0BB4D4] underline-offset-4 transition-colors duration-500 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0057B8] group-hover:text-cyan-200 group-focus-within:text-cyan-200"
        >
          ...
          {vertical.items.map((item) => (
            ...
            >
              <Icon
                ...
                width={16}
                aria-hidden="true"
                className="mt-0.5 shrink-0 text-[#0BB4D4] transition-colors duration-500 group-hover:text-cyan-200 group-focus-within:text-cyan-200"
              />
              <span>{item}</span>
            </li>
          ))}
